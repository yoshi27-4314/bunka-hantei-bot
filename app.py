...
　★時間をかけない。最大3点。商品によっては外観だけでよい。
　★動作確認は必要な商品だけ（電化製品・機械類）。食器・家具・雑貨は外観のみ。
　★1項目＝1文。短く。

　確認項目の選び方：
　・外観だけでよい商品（食器・家具・雑貨・衣類・装飾品）→ 1〜2点
　　例：「欠け・ヒビを確認」「傷・汚れを確認」
　・動作確認が必要な商品（家電・工具・カメラ・楽器）→ 2〜3点
　　例：「電源を入れる」「異音がないか」「付属品の有無」
